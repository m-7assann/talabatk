    ...
    <div class="row row-gap-24 w-100 mt-3 mx-0 px-0">
        <div class="col-sm-6 col-xl-3">
            <div class="box-info green">
                <div class="d-flex px-2 py-3  align-items-center justify-content-between">
                    ...
                    <div class="text">
                        <div class="num ">{{ App\Models\Resturant::count() }}</div>
                        <div class="name">عدد المطاعم</div>
                    </div>
                </div>
                <a href="{{ route('admin.resturants') }}" class="link">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="box-info yellow">
                ...
                <a href="{{ route('admin.orders') }}" class="link">
                    <i class="fas fa-arrow-alt-circle-right"></i>
                    المزيد
                </a>
            </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="box-info blue">
                <div class="d-flex px-2 py-3  align-items-center justify-content-between">
                    ...
                    <div class="text">
                        <div class="num ">{{
                            App\Models\Meal::where('discount', '>', '0')->count() }}
                        </div>
                        <div class="name"> عدد العروض </div>
                    </div>
                </div>
                <a href="{{ route('admin.offers') }}" class="link">
                    <i class="fas fa-arrow-alt-circle-right"></i>
                    المزيد
                </a>
            </div>
            ...
            <div class="box-info red">
                <div class="d-flex px-2 py-3  align-items-center justify-content-between">
                    ...
                    <div class="text">
                        ...
                        <div class="name"> عدد المستخدمين </div>
                    </div>
                </div>
